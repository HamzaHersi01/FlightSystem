...
public class AddFlightWindow extends JFrame implements ActionListener {
    ...
    private JTextField flightCapacityText= new JTextField();
    ...
    private void initialize() {
        ...
        topPanel.add(flightCapacityText);
    ...
    private void addBook() {
        try {
            ...
            int flightCapacity = Integer.parseInt(flightCapacityText.getText());
            int price = Integer.parseInt(priceText.getText());
            
            // create and execute the AddFlight Command
            Command addFlight = new AddFlight(flightNumber, origin, destination, departureDate,flightCapacity, price);
